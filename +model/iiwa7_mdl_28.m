function lbr = iiwa7_mdl_28(x,tau)
...
% create links
L(1) = Link('offset', 0+x(1)+x(22)*tau(1), 'd', d_bs+x(8), 'a',0+x(29), 'alpha', -0.5*pi+x(15), 'standard','I', I1, 'm', M(1), 'r', RC(1,:), 'Jm', 0); 
L(2) = Link('offset', 0+x(2)+x(23)*tau(2), 'd', 0+x(9), 'a',0+x(30),   'alpha', 0.5*pi+x(16), 'standard','I', I2, 'm', M(2), 'r', RC(2,:), 'Jm', 0);
L(3) = Link('offset', pi+x(3)+x(24)*tau(3), 'd', d_se+x(10),  'a',0+x(31),   'alpha', -0.5*pi+x(17), 'standard','I', I3, 'm', M(3), 'r', RC(3,:), 'Jm', 0);
L(4) = Link('offset', 0+x(4)+x(25)*tau(4), 'd', 0+x(11),  'a',0+x(32),  'alpha', 0.5*pi+x(18), 'standard','I', I4, 'm', M(4), 'r', RC(4,:), 'Jm', 0);
L(5) = Link('offset', pi+x(5)+x(26)*tau(5), 'd', d_ew+x(12),  'a',0+x(33),  'alpha', -0.5*pi+x(19), 'standard','I', I5, 'm', M(5), 'r', RC(5,:), 'Jm', 0);
L(6) = Link('offset', 0+x(6)+x(27)*tau(6), 'd', 0+x(13),  'a',0+x(34),  'alpha', 0.5*pi+x(20), 'standard','I', I6, 'm', M(6), 'r', RC(6,:), 'Jm', 0);
L(7) = Link('offset', 0+x(7)+x(28)*tau(7), 'd', d_wt+x(14),  'a',0+x(35),  'alpha',0+x(21), 'standard','I', I7, 'm', M(7), 'r', RC(7,:), 'Jm', 0);
